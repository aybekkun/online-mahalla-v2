...
export const translations = {
  en: {
    ...
    heroSubtitle: "Discover innovative projects across Uzbekistan driving economic growth and creating opportunities",
  ...
  ru: {
    ...
    heroSubtitle: "Откройте для себя инновационные проекты по всему Узбекистану, способствующие экономическому росту",
    ...
    // Footer
    footerDescription: "Демонстрация 100 самых эффективных микро и бизнес-проектов по всей Республике Узбекистан.",
